...
setenv SINGULARITYENV_ASSIGNS_FILE ASSIGNS.EDGAR.cmaq.cb05_soa.HEMI_108k
...
setenv SINGULARITYENV_RUN_CNTLMAT   N          # run control and growth matrix program
...
## Quality assurance
setenv SINGULARITYENV_RUN_SMKREPORT N         # run emissions reporting program

## Program-specific controls...

## For Smkinven
setenv SINGULARITYENV_IMPORT_GRDNETCDF_YN  Y   # Y import EDGAR gridded inventories
setenv SINGULARITYENV_NETCDF_POL_UNIT 'kg m-2 s-1'   # define the unit of EDGAR variables
setenv SINGULARITYENV_NETCDF_INV_YEAR    2010  # defibe the year of EDGAR inventories
...
setenv SINGULARITYENV_USE_EXP_GEO_CODES    Y   # use geographical code instead of COSTCY file
setenv SINGULARITYENV_DAY_SPECIFIC_YN      N   # process daily invenotry 
setenv SINGULARITYENV_HOUR_SPECIFIC_YN     N   # process daily invenotry 
...
## Script settings
setenv SINGULARITYENV_SRCABBR            edgar # abbreviation for naming log files
setenv SINGULARITYENV_QA_TYPE             all  #   all # type of QA to perform [none, all, part1, part2, or custom]
