...
setenv SINGULARITYENV_USE_REF_SCC_YN       N   # Y disaggregate SCC8 activity to full SCC10
setenv SINGULARITYENV_EXCLUDE_REF_SCC_YN   N   # Y drop SCCs not found in SCCXREF input file
...
# For Movesmrg
setenv SINGULARITYENV_RPD_MODE             N          # Y process on-roadway emission factors
...
setenv SINGULARITYENV_RPH_MODE             Y          # Y process off-network vapor venting EFs
...
## Script settings
setenv SINGULARITYENV_SRCABBR              rateperhour # abbreviation for naming log files
